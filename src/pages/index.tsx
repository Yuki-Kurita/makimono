        ...
        <div className="container mx-auto">
          <div className="text-center px-3 lg:px-0">
            <h1 className="my-4 text-2xl md:text-3xl lg:text-5xl font-black leading-tight">
              情報を体系化した「手引き」をシェアしよう
            </h1>
            <p className="leading-normal text-gray-800 text-base md:text-xl lg:text-2xl mb-8">
              Tebikiは、様々な学習方法や知識などの情報を体系化した「手引き」を作成し、みんなでシェアすることができるサービスです。
            </p>
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 sm:w-1/2 p-6">
                ...
                <p className="text-gray-600 mb-8">
                  世の中には非常にたくさんの情報で溢れかえっています。
                  Tebikiはそんなたくさんの情報を体系化した「手引き」をユーザー同士でシェアすることで、より有用なまとまった情報を得ることを実現します。
                </p>
              </div>
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-8">
                    何かを学ぶ時に、どういった手順で学べばいいのか、何を参考にしたらいいのかわからなくなることがあります。
                    Tebikiを使えばみんなの手引きを自身の学習の道標に使うことができます。
                  </p>
                </div>
              </div>
            </div>
